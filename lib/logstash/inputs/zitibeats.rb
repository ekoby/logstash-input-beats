...
class LogStash::Inputs::Beats < LogStash::Inputs::Base
  ...
  def create_server
    server = org.openziti.logstash.beats.Server.new(@ziti_identity, @ziti_service,  @client_inactivity_timeout, @executor_threads)
